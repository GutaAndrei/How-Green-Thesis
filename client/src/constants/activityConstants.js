...
export const ACTIVITY_ADD_DEVICES_REQUEST = "ACTIVITY_ADD_REQUEST";
export const ACTIVITY_ADD_DEVICES_SUCCESS = "ACTIVITY_ADD_SUCCESS";
export const ACTIVITY_ADD_DEVICES_FAIL = "ACTIVITY_ADD_FAIL";
